...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 1805.0, 75.0, 106.0, 32.0 ],
					"style" : "",
					"text" : "A-300Pro"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 1272.0, 122.0, 414.0, 219.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 192.0, 608.0, 58.0, 32.0 ],
					"style" : "",
					"text" : "+ 48"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 558.0, 838.0, 58.0, 32.0 ],
					"style" : "",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 115.0, 553.0, 82.0, 32.0 ],
					"style" : "",
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 97.0, 461.0, 178.0, 32.0 ],
					"style" : "",
					"text" : "QuNexus-NEWEST"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 917.121948, 539.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.0, 539.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 687.0, 140.0, 32.0 ],
					"style" : "",
					"text" : "loadmess 80"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 475.0, 731.0, 188.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 746.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 713.0, 585.0, 200.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 886.0, 630.0, 225.0, 32.0 ],
					"style" : "",
					"text" : "scale 0. 2. -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 966.0, 585.0, 117.0, 32.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "float" ],
					"patching_rect" : [ 345.0, 49.5, 739.121948, 477.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 1.5, 739.121948, 477.5 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 345.0, 603.0, 182.0, 78.0 ],
					"style" : "",
					"text" : "organ"
				}
...
, 			{
				"name" : "A-300Pro-faders-view.maxpat",
				"bootpath" : "D:/Projects/MaxPatches/A-300Pro",
