...
,
		"classnamespace" : "box",
		"rect" : [ 583.0, 179.0, 1098.0, 1092.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 849.0, 50.0, 61.0 ],
					"text" : "0 770"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 391.0, 901.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 628.0, 774.0, 340.5, 35.0 ],
					"text" : "organ-2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 1001.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 41.0, 88.0, 200.0, 35.0 ],
					"text" : "OSC-route /organ"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 776.0, 400.0, 80.0, 35.0 ],
					"text" : "61 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 802.0, 519.0, 80.0, 35.0 ],
					"text" : "60 107"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.0, 466.0, 116.0, 35.0 ],
					"text" : "60 127.34"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 302.0, 56.0, 35.0 ],
					"text" : "60 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 590.0, 455.0, 80.0, 35.0 ],
					"text" : "0 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 50.0, 421.0, 80.0, 35.0 ],
					"text" : "unjoin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 355.0, 80.0, 35.0 ],
					"text" : "60 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 444.0, 56.0, 35.0 ],
					"text" : "0 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.0, 444.0, 68.0, 35.0 ],
					"text" : "0 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 252.0, 774.0, 340.5, 35.0 ],
					"text" : "organ-2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 50.0, 146.0, 1208.0, 35.0 ],
					"text" : "OSC-route /noteAndVel /drawbarAndFreqMult /drawbarAndAmp /drawbarAndDecay /noteAndCustomFreq /volume"
				}
