...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 864.75, 720.0, 56.0, 23.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 789.0, 720.0, 56.0, 23.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 643.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess b1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 755.0, 679.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "sample-looper"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 517.835999, 666.0, 56.0, 23.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 442.085999, 666.0, 56.0, 23.0 ],
					"sig" : 0.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 641.0, 509.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 568.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess b0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 419.0, 630.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "sample-looper"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 442.085999, 504.0, 131.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 893.0, 490.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1137.75, 313.0, 266.5, 103.0 ],
					"viewvisibility" : 1
				}
