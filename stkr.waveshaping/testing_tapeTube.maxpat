...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.625, 134.0, 51.0, 18.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.375, 401.0, 96.900002, 20.0 ],
					"text" : "pack 11025. 42."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 318.375, 421.0, 76.5, 20.0 ],
					"text" : "line~ 11025."
				}
...
,
					"patching_rect" : [ 337.375, 381.0, 61.199997, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 290.157501, 341.0, 64.6875, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 494.399994, 281.0, 33.149998, 20.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.35997, 134.0, 33.66, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.219955, 134.0, 58.139999, 18.0 ],
					"text" : "startloop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 149.299973, 133.0, 46.919998, 20.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 86.699997, 153.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 86.699997, 173.0, 33.149998, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 86.699997, 193.0, 81.599998, 20.0 ],
					"text" : "selector~ 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 149.299973, 153.0, 137.699997, 20.0 ],
					"text" : "groove~ trial 1 @loop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 291.625, 153.0, 132.599991, 20.0 ],
					"text" : "buffer~ trial anton.aif 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 163.0, 421.0, 119.339996, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 290.157501, 301.0, 55.079998, 20.0 ],
					"text" : "f 11025."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 423.785004, 53.0, 88.229996, 20.0 ],
					"text" : "t b 1 l b b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "float" ],
					"patching_rect" : [ 290.225006, 381.0, 47.149998, 20.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.785004, 33.0, 172.37999, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 420.065002, 471.592773, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 290.157501, 361.0, 64.6875, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.237488, 301.0, 90.779999, 20.0 ],
					"text" : "expr $f1 * 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 479.313324, 261.0, 64.260002, 20.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.440002, 53.0, 159.119995, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 254.5, 193.0, 56.0, 20.0 ],
					"sig" : -3.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 185.875, 193.0, 56.0, 20.0 ],
					"sig" : 3.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 106.0, 471.592773, 49.98, 20.0 ],
					"text" : "*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 514.092773, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 118.0, 93.0, 56.0, 20.0 ],
					"sig" : 110.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 118.0, 113.0, 45.899998, 20.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 231.625, 273.0, 56.0, 20.0 ],
					"sig" : -4.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 208.75, 233.0, 56.0, 20.0 ],
					"sig" : 6.0
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 660.599976, 44.0, 30.599998, 20.0 ],
									"text" : "in 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.400002, 76.0, 30.599998, 20.0 ],
									"text" : "in 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 660.599976, 14.0, 30.599998, 20.0 ],
									"text" : "in 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.400002, 14.0, 30.599998, 20.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.400002, 44.0, 30.599998, 20.0 ],
									"text" : "in 2"
								}
...
,
					"patching_rect" : [ 163.0, 313.0, 110.5, 20.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 173.0, 57.0, 20.0 ],
					"text" : "outgain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.375, 173.0, 57.0, 20.0 ],
					"text" : "ingain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 264.75, 233.0, 57.0, 20.0 ],
					"text" : "drive"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.98, 153.0, 150.0, 20.0 ],
					"text" : "cycle~ / file >"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 96.199997, 456.796387, 301.125, 456.796387 ],
					"source" : [ "obj-26", 0 ]
				}
