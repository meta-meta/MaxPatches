...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 100.5, 128.0, 143.0, 22.0 ],
					"style" : "",
					"text" : "midiparse"
				}
...
,
					"patching_rect" : [ 100.5, 155.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 162.5, 228.0, 300.0, 100.0 ],
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"pluginname" : "EWI USB VST_x86.dll",
							"plugindisplayname" : "EWI USB VST_x86",
							"pluginsavedname" : "C:/Program Files/Akai/EWI USB/VST/EWI USB VST_x86.dll",
...
,
						"snapshotlist" : 						{
							...
							"entries" : [ 								{
									...
									"version" : 2,
									"minorversion" : 0,
									"name" : "EWI USB VST_x86.dll",
									"origin" : "EWI USB VST_x86.dll",
									"type" : "VST",
									"subtype" : "Instrument",
									"embed" : 0,
									"snapshot" : 									{
...
,
									"fileref" : 									{
										"name" : "EWI USB VST_x86.dll",
										"filename" : "EWI USB VST_x86.dll.maxsnap",
										"filepath" : "~/Max 7/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "f88a51e191065bda8e32ab633731526d"
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.5, 180.0, 70.0, 23.0 ],
					"style" : "",
					"text" : "plug"
				}
