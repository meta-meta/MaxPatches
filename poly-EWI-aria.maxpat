...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 130.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 54.5, 298.0, 362.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, "C:/Program Files/Akai/EWI USB/VST/EWI USB VST_x64.dll", ";" ],
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"pluginname" : "EWI USB VST_x64.dll",
							"plugindisplayname" : "EWI USB",
							"pluginsavedname" : "C:/Program Files/Akai/EWI USB/VST/EWI USB VST_x64.dll",
							...
							"sliderorder" : [  ],
							"slidervisibility" : [  ],
							"blob" : "385.CMlaKA....fQPMDZ....ADzRAUD...P......VVavQWdfLGauQGL.........................DPQCUzQP8e....dbVVTA6lvvvPuOo8OXkSaGnMsv3T6PvFZiIMIzJSb1zZfnklrkjx.95WZKkg17Ia+d44mcRFsuTB6HiUnUorn.NCFc+0WkL1HvLbGcAFevcLOD3ijLx4DpMVv5LDV5SSY8iYvWUnT3N3YyfMR8JTNWKOzh0VunR0vlGvaBFTh6yZTYrTpyecRJK9tgLvliRzyKB5ATstA1b4o1OPJGYRYC4mZ7FIalY3YCJ0NPT3eOCTXIUKT.rTqK9VnJrg9hLbu9ysZEYC8ovBRoM9Y8Bd7HbyhmukAqP0GoroKmAumMAdjViURGLw2sEaVQ8YgOfA4aQkp1C8h5tQM1XNZvxFe3M2NTVUajfHdb+gw+51+PM9BpcGoyKVX8l0ULc8ZJ28+cMWWF7DZLBGpBFWtRPpbpUjjvtuVewO.M5bjbC"
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
...
,
									"fileref" : 									{
										"name" : "EWI USB",
										"filename" : "EWI USB.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "4ab1766dd0587901e9e15a65c6a090cc"
									}
...
,
					"text" : "vst~ \"C:/Program Files/Akai/EWI USB/VST/EWI USB VST_x64.dll\"",
					"varname" : "vst~[1]",
					"viewvisibility" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 103.452377319335938, 111.0, 143.0, 22.0 ],
					"text" : "midiparse"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 990.666625999999951, 310.0, 29.5, 20.0 ],
									"text" : "225"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 959.333312999999976, 280.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 956.0, 391.0, 120.0, 20.0 ],
									"text" : "midievent 225 0 64"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 959.333312999999976, 338.0, 113.0, 20.0 ],
									"text" : "pack midievent 225 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1022.0, 208.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1022.0, 228.0, 66.0, 19.0 ],
									"text" : "LSB (7-bit)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 956.0, 228.0, 69.0, 19.0 ],
									"text" : "MSB (7-bit)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 956.0, 208.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "int", "int" ],
									"patching_rect" : [ 956.0, 183.0, 151.0, 21.0 ],
									"text" : "xbendin2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 946.0, 58.0, 28.0, 28.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 580.0, 122.0, 50.0, 20.0 ],
									"text" : "64"
								}
...
,
					"patching_rect" : [ 91.642852783203125, 180.0, 143.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.5, 178.0, 70.0, 23.0 ],
					"text" : "plug"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 467.0, 44.0, 22.0 ],
					"text" : "out~ 2"
				}
