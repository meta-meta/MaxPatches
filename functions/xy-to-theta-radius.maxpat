...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.5, 6.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 335.0, 241.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 367.5, 40.0, 220.0, 31.0 ],
					"style" : "PupleStyle",
					"text" : "theta|radius"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 187.0, 158.0, 84.0, 33.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 196.0, 196.0, 75.0, 33.0 ],
					"text" : "sqrt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 258.0, 114.0, 63.0, 33.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 187.0, 114.0, 63.0, 33.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 50.5, 192.0, 106.0, 33.0 ],
					"text" : "/ 6.282"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 50.5, 153.0, 125.0, 33.0 ],
					"text" : "+ 3.14159"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 50.5, 114.0, 120.0, 33.0 ],
					"text" : "atan2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 283.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 251.0, 57.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 471.5, 6.0, 79.0, 33.0 ],
					"style" : "PurpleStyle2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.5, 244.0, 57.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 390.5, 6.0, 79.0, 33.0 ],
					"style" : "PurpleStyle2"
				}
