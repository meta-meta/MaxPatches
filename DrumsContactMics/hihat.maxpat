...
,
		"rect" : [ 896.0, 1615.0, 1676.0, 792.0 ],
		"bglocked" : 0,
...
,
					"patching_rect" : [ 1367.0, 427.0, 130.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1261.0, 515.0, 130.0, 32.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1229.0, 601.0, 233.0, 120.0 ],
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 970.0, 376.0, 130.0, 32.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 618.0, 393.0, 150.0, 30.0 ],
					"style" : "",
					"text" : "topHigh"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.5, 393.0, 150.0, 30.0 ],
					"style" : "",
					"text" : "topLow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 612.0, 544.0, 150.0, 30.0 ],
					"style" : "",
					"text" : "bottomHigh"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.5, 544.0, 150.0, 30.0 ],
					"style" : "",
					"text" : "bottomLow"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 557.0, 309.0, 272.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 270.0, 309.0, 272.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 551.0, 460.0, 272.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 261.5, 460.0, 272.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 800.0, 210.0, 225.0, 32.0 ],
					"style" : "",
					"text" : "OSC-route /g /f /q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 551.0, 210.0, 225.0, 32.0 ],
					"style" : "",
					"text" : "OSC-route /g /f /q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 226.0, 134.0, 874.0, 32.0 ],
					"style" : "",
					"text" : "OSC-route /bottomLow /bottomHigh /topLow /topHigh /topPitch /bottomPitch"
				}
