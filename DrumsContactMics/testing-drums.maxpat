...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1409.0, 161.0, 100.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 607.0, 333.0, 80.0, 32.0 ],
					"text" : "hi-tom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 971.0, 203.0, 68.0, 32.0 ],
					"text" : "snare"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 853.0, 40.0, 228.0, 148.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 249.0, 339.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 290.0, 691.0, 56.0, 32.0 ],
					"text" : "kick"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 753.0, 148.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 753.0, 196.0, 80.0, 32.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 828.0, 357.0, 1024.0, 512.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.5, 719.5, 1024.0, 220.0 ],
					"scroll" : 3,
					"sono" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 578.0, 769.0, 68.0, 32.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 584.0, 830.0, 56.0, 32.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 384.0, 625.0, 68.0, 32.0 ],
					"text" : "snare"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 168.0, 26.0, 284.0, 104.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.0, 413.0, 414.0, 138.0 ],
					"viewvisibility" : 1
				}
