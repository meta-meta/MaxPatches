...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.0, 494.0, 29.5, 32.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 243.0, 550.0, 214.0, 32.0 ],
					"style" : "",
					"text" : "combine / #1/ val"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 243.0, 462.0, 70.0, 32.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 232.0, 605.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 661.0, 931.0, 30.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 111.0, 407.0, 89.0, 89.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 173.5, 150.0, 48.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 111.0, 282.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 184.0, 340.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "delay 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 111.0, 340.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "onebang 1"
				}
...
,
					"patching_rect" : [ 178.0, 187.0, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 295.0, 199.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 312.0, 26.0, 20.0 ],
					"style" : "",
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 111.0, 312.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 111.0, 252.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "> 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 111.0, 217.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.5, 187.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "bucket"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 111.0, 144.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "peakamp~ 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 120.5, 174.0, 134.0, 174.0 ],
					"order" : 1,
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 120.5, 174.0, 187.5, 174.0 ],
					"order" : 0,
					"source" : [ "obj-47", 0 ]
				}
