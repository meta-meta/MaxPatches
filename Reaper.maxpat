...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 987.0, 684.0, 150.0, 31.0 ],
					"text" : "beats"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 961.0, 684.0, 70.0, 33.0 ],
					"text" : "1528"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1009.0, 637.0, 50.0, 33.0 ],
					"text" : "/ 24"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1064.0, 626.0, 150.0, 55.0 ],
					"text" : "24 bangs per quarter note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 973.0, 239.0, 150.0, 79.0 ],
					"text" : "from loopMidi sent by Reaper"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 954.0, 404.5, 70.0, 33.0 ],
					"text" : "sync~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1036.0, 574.0, 166.0, 33.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1050.0, 455.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 1052.0, 501.0, 85.0, 33.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 839.0, 529.0, 176.0, 33.0 ],
					"text" : "bpm 120."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1016.0, 331.0, 43.0, 33.0 ],
					"text" : "rtin"
				}
...
,
					"patching_rect" : [ 732.0, 724.0, 140.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 867.0, 398.0, 103.0, 33.0 ],
									"style" : "PupleStyle"
								}
...
,
					"patching_rect" : [ 707.0, 684.0, 140.0, 33.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Fira Code",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 628.0, 347.0, 227.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 569.0, 589.0, 74.0, 33.0 ],
					"text" : "APC40"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 36.0, 324.0, 536.0, 203.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 324.0, 536.0, 203.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 563.0, 101.0, 361.0, 111.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 502.0, 780.0, 353.0, 96.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 587.0, 685.0, 276.0, 90.0 ],
					"viewvisibility" : 1
				}
