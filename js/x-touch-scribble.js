...
var set = function set(msg, track) {
  var line = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  // ['f0', '00', '00', '66', '14', '12']
  var sysex = [240, 0, 0, 102, 20, 18].concat(line * 7 * 8 + track * 7 // .toString(16)
  // .padStart(2, '0')
  ).concat(msg.padEnd(7).substr(0, 7).split('').map(function (c) {
    return c.charCodeAt(0);
  }
  /*.toString(16)*/
  )).concat(
  /*'f7'*/
  247).forEach(function (n) {
    outlet(0, n);
  });
};
