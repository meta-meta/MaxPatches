...
<html lang="en">
<head>
    <title>Code coverage report for es5.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> es5.js
    </h1>
    <div class='clearfix'>
...
var memo = function (fn, cache) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if ( cache === void 0 ) cache = {};
&nbsp;
 ...
 * type('Imaj7') // =&gt; 'maj7'
 */
var type = <span class="fstat-no" title="function not covered" >fu</span>nction (str) { <span class="cstat-no" title="statement not covered" >return props(str).type; </span>};
&nbsp;
/**
 ...
 */
var fromDegree = function (degree, isMajor) { return getNames(isMajor)[degree - 1] || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span> };
&nbsp;
exports.props = props;
exports.names = names;
exports.name = name;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Feb 15 2019 01:07:33 GMT+0100 (CET)
</div>
</div>
