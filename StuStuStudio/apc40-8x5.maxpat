...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 162.0, 563.0, 31.0 ],
					"text" : "if $i1 >= 1 && $i1 <=8 && $i2 >= 53 && $i2 <= 57 then 1 else 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 460.0, 477.38330078125, 208.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, -1.0, 226.38330078125, 144.738311767578125 ],
					"rows" : 5
				}
