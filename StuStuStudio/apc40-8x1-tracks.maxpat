...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.0, 108.0, 442.0, 31.0 ],
					"text" : "if $i1 >= 1 && $i1 <=8 && $i2 == 51 then 1 else 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.5, 174.0, 47.0, 31.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 150.38330078125, 68.0, 34.0, 31.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.88330078125, 608.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 136.0, 282.0, 71.0, 31.0 ],
					"text" : "== 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 39.0, 282.0, 32.0, 31.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.88330078125, 333.0, 56.0, 31.0 ],
					"text" : "join 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 80.082763671875, 282.0, 43.0, 31.0 ],
					"text" : "- 51"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 78.38330078125, 228.0, 79.0, 31.0 ],
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 199.0, 350.0, 386.38330078125, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, -1.0, 226.38330078125, 31.738311767578125 ],
					"rows" : 1
				}
