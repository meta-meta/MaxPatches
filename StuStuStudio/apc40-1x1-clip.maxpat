...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 162.0, 338.0, 31.0 ],
					"text" : "if $i1 == 1 && $i2 == 81 then 1 else 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 460.0, 52.38330078125, 52.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, -1.0, 36.38330078125, 35.738311767578125 ],
					"rows" : 1
				}
